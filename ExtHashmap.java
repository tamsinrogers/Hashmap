...
public class ExtHashmap<K,V> implements MapSet<K,V> 
{
	...
	/* constructor */
	public ExtHashmap(Comparator<K> comp) 
	{
	...
	public ExtHashmap(Comparator<K> comp, int capacity) 
	{
    ...
    public static void main( String[] argv ) 
    {
            ...
            ExtHashmap<String, Integer> test = new ExtHashmap<String, Integer>( as , 10);	
